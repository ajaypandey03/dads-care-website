...
export default function Services() {
  ...
  useEffect(() => {
    ...
    const cards = sectionRef.current?.querySelectorAll('.scroll-fade');
  ...
  const services = [
    {
      icon: (
        <svg className="w-12 h-12 text-blue-700" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {services.map((service, index) => (
            <div
              key={index}
              className="scroll-fade bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 border border-gray-100"
