    ...
    <footer className="bg-blue-900 text-white py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="border-t border-blue-700 mt-8 pt-4 text-center text-gray-300">
          <p>
            © 2025 DAD&apos;S CARE Logistics Solutions Pvt. Ltd. | <a href="#" className="hover:text-white transition-colors">Privacy Policy</a> | <a href="#" className="hover:text-white transition-colors">Terms</a>
          </p>
        </div>
      </div>
    </footer>
